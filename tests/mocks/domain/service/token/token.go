...
// Source: internal/domain/service/token/token.go
//
// Generated by this command:
//
//	mockgen -source=internal/domain/service/token/token.go -destination=tests/mocks/domain/service/token/token.go
//
