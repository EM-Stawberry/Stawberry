...
func (m *MockMailerService) OfferReceived(offerID uint, userMail string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OfferReceived", offerID, userMail)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockMailerService) Registered(userName, userMail string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Registered", userName, userMail)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockMailerService) StatusUpdate(offerID uint, status, userMail string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StatusUpdate", offerID, status, userMail)
	ret0, _ := ret[0].(error)
	return ret0
}
